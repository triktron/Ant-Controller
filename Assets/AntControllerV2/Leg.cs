...
public class Leg : MonoBehaviour
{
    ...
    public bool IsOutsideSafeZone() => Vector3.Distance(_Position, _IdealePosition) > .2f;
    ...
    private void Update()
    {
        if (IsMoving())
        {
            ...
            _Position = Vector3.Lerp(_StartPosition, _TargetPosition, _StepProgress) + _TargetPositionNormal * _StepCurve.Evaluate(_StepProgress);
        }
